...
//    }
    ...
    public String updateTo(Article article, @RequestParam("file") MultipartFile file) {
        String saveName = String.valueOf(new Date().getTime());
    ...
    public String deleteTo(Article article, @RequestParam("file") MultipartFile file) {
        String saveName = String.valueOf(new Date().getTime());
